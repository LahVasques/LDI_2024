        ...
        <div class="container">
            <div class="container_processo">
                ...
                <?php
                    ...
                    $cod = $_GET['cod'];
                    $excluir = "delete from tbamigos where cod = '$cod' ";
                    $executar = mysqli_query($conn, $excluir);
                    if ($executar) {
                        echo '<h1>Amigo Excluído com sucesso</h1>';
                        echo '<a href="/projetob/view/index.php"><button>Voltar ao Menu</button></a>';  
                    } else {
                        echo '<h1>Erro de dados, amigo não excluído</h1>';
